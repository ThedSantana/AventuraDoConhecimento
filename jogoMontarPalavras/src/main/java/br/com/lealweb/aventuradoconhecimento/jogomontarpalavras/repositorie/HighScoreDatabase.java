...
public class HighScoreDatabase {
	...
	private static final String DATABASE_NAME = "word_highscore.db";
	private static final int DATABASE_VERSION = 1;
	public static final int MAX_ENTRIES = 10;
	private static final String TABLE_NAME = "word_highscore";
	...
	public List<HighScoreEntry> getSortedHighScores() {
		...
		try {
			...
			String sortOrder = "score DESC, _id"; // SQL ORDER BY
